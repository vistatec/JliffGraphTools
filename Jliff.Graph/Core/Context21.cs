...
namespace Localization.Jliff.Graph.Core
{
    public class Context21
    {
        ...
        public string Gls => "urn:oasis:names:tc:xliff:glossary:2.0";
        public string Its => "https://www.w3.org/2005/11/its/";
        public string Itsm => "urn:oasis:names:tc:xliff:itsm:2.1";
        public string Md => "urn:oasis:names:tc:xliff:metadata:2.0";
        public string Mtc => "urn:oasis:names:tc:xliff:matches:2.0";
        public string Res => "urn:oasis:names:tc:xliff:resourcedata:2.0";
